"""
FineWeb-Edu dataset preprocessor.
...
def tokenize(doc):
    """Tokenize a single document, prepending the end-of-text delimiter token.

    Returns a uint16 numpy array; the eot token separates documents in the stream.
    """
    tokens = [eot]
